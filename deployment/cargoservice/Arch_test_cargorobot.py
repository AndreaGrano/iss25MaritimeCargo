...
with Diagram('test_cargorobotArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     test >> Edge(color='blue', style='solid',  decorate='true', label='<go &nbsp; >',  fontcolor='blue') >> cargorobot
diag
