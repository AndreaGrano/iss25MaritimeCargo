	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("wait") { //this:State
					action { //it:State
						CommUtils.outred("$name: waiting for events...")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
					}	 	 
					 transition(edgeName="t06",targetState="turnledon",cond=whenEvent("stop"))
					transition(edgeName="t07",targetState="turnledoff",cond=whenEvent("resume"))
				}	 
